 ...
 * This ensures each test starts with a fresh game state
 */
async function restartDockerServer() {
  console.log('Restarting Docker backend container...');
  
  try {
    // Restart only the backend container to clear in-memory state
    ...
    // Additional wait for WebSocket to be ready
...
test.describe('Three Player Complete Hand', () => {
  ...
  test.beforeEach(async () => {
    // Restart Docker server to clear state
