...
2. **Delegate Research**: Use `@subagent/planner.md` to invoke the planning-subagent for comprehensive context gathering. Instruct it to work autonomously without pausing.
...
### 2A. Implement Phase
1. Use `@subagent/implementer.md` to invoke the implement-subagent with:
...
1. Use `@subagent/reviewer.md` to invoke the code-review-subagent with:
